...
func (StripeRequests StripeRequests) GetClientSecret(userId string, CartRequests cart.IRequests, CartDB cart.IRepository, CartUtils cart.IUtils) (*string, error) {
