...
func main() {
	...
	h.SetupRoutesForCart(app, cart.Requests{}, cart.CartDB{}, users.UserRequests{}, cart.Utils{}, users.UserDB{})
	//h.SetupRoutesForManufacturer(app, manufacturer.ExampleManufacturerRequests{})
	h.SetupRoutesForStripe(app, cash.ExampleTransactionRequests{}, cash.StripeRequests{}, cart.Requests{}, cart.CartDB{}, cart.Utils{}, items.ItemDB{}, cash.ExampleTransactionDBHistory{}, users.UserRequests{}, users.UserDB{DB: db})
